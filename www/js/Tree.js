...
Tree = function(sizeBranch, sizeTrunk, radius, scene, sg) {
    ...
    var branchColor = randomColor({hue: 'green', luminosity: 'dark', format: 'rgbArray'});
    ...
    sg.getShadowMap().renderList.push(this);
    sg.getShadowMap().renderList.push(this.trunk);
...
Tree.prototype._init = function(sizeBranch) {
    ...
    var nPolygons = 7;
    var vertexData = BABYLON.VertexData.CreateSphere(nPolygons,sizeBranch);
